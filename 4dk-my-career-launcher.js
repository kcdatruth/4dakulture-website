...
(() => {
  ...
  sec.innerHTML=`<div class="shell"><div class="dp-head"><div><span class="dp-eyebrow">4DK NBA • 2026–27 TEAM OUTLOOKS</span><h2>FIVE DIVISION<br>PREVIEWS ARE LIVE.</h2></div><p>Twenty-five teams are now on the board. The East is complete, the Northwest is live, and the Pacific adds Luka's Lakers, Phoenix's crossroads and one more ride with Steph.</p></div><div class="dp-grid">
